/* Movie´s Search Page generated by JSetup v0.95 :  at 01/12/2019 12:41:14  */
...
export default class PageMovie extends React.Component {
    ...
    create = () => {
        // this.$router.push({ path: "/movies/new/" });
    }

    editMovie = (_movie) => {
        // this.$router.push({ path: "/movies/edit/" + _movie.id });
        console.log("editando movie ", _movie);
    }
    ...
    removeMovie = (_movie) => {
        console.log("removendo movie ", _movie);
    }
    ...
    paginate = (pageIndex = 1) => {
        ...
        this.service.getPage(
            ...
            error => {
                console.error("error fetching movie´s page", error);
            }
        );
    }
                    ...
                    <div className="panel-body">
                        ...
                        <form id="formMovieFilter">
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/movies/new">Novo Registro </NavLink>
                                    ...
                                    <div className="col-sm-6">
                						<div className="input-group">
                                            <input type="text" value={this.state.datatableConfig.filterParameters.title} className="form-control" placeholder="Pesquisar Filme por por Title" />
                            ...
                            <div className="panel" style={{ display: this.state.showFilter ? "block" : "none" }} >
                                ...
                                <div className="panel-body">
	                                <FormGroup controlId="controlIdTitle"  > 
	                                    <ControlLabel>Title</ControlLabel>
	                                    <JSInputField name="title" type="text" value={this.state.datatableConfig.filterParameters.title}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
	                                ...
	                                <FormGroup controlId="controlIdDuration"  > 
	                                    <ControlLabel>Duration</ControlLabel>
	                                    <JSInputField name="duration" plugin="integer" type="text" value={this.state.datatableConfig.filterParameters.duration}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
	                                <FormGroup controlId="controlIdReleaseDate"  > 
	                                    <ControlLabel>Release date</ControlLabel>
	                                    <JSInputField name="releaseDate" plugin="date" type="text" value={this.state.datatableConfig.filterParameters.releaseDate}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
	                                ...
	                                <FormGroup controlId="controlIdDirector"  > 
	                                    <ControlLabel>Director</ControlLabel>
	                                    <JSInputField name="director" type="text" value={this.state.datatableConfig.filterParameters.director}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
                                    <div>
                        ...
                        <div className="cente">
                            <div className="table-responsive ">
                                ...
                                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                        {
                                            this.state.datatableConfig.items.map((movie, index) => {
                                                return (
                                                    <tr key={movie.id}>
                                                        <td>{movie.title}</td>
                                                        <td>{movie.poster}</td>
                                                        ...
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editMovie(movie)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeMovie(movie)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Movie">
