/* Genre´s Search Page generated by JSetup v0.95 :  at 01/12/2019 12:41:14  */
...
export default class PageGenre extends React.Component {
  constructor(props) {
    super(props)
  ...
  create = () => {
    // this.$router.push({ path: "/genres/new/" });
  }

  editGenre = (_genre) => {
    // this.$router.push({ path: "/genres/edit/" + _genre.id });
    console.log("editando genre ", _genre);
  }
  ...
  removeGenre = (_genre) => {
    console.log("removendo genre ", _genre);
  }
  ...
  paginate = (pageIndex = 1) => {
    ...
    this.service.getPage(
      ...
      error => {
        console.error("error fetching genre´s page", error);
      }
    );
  }
              ...
              <div className="row">
                <div className="page-toolbar">
                  <div className="col-sm-6">
                    <NavLink className="btn btn-info" to="/genres/new">Novo Registro </NavLink>
                  ...
                  <div className="col-sm-6">
                    <div className="input-group">
                      <input type="text" value={this.state.datatableConfig.filterParameters.name} className="form-control" placeholder="Pesquisar Filme por por Name" />
            ...
            <div className="cente">
              <div className="table-responsive ">
                ...
                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                  ...
                  <tbody>
                    {
                      this.state.datatableConfig.items.map((genre, index) => {
                        return (
                          <tr key={genre.id}>
                            <td>{genre.name}</td>
                            <td>{genre.description}</td>
                            <td className="td-actions action-butons-cell">
                              <button className="btn btn-xs  btn-primary " onClick={(event) => this.editGenre(genre)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                <i className="fa fa-pencil fa-lg" />
                              </button>

                              <button className="btn btn-xs btn-danger " onClick={(event) => this.removeGenre(genre)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Genre">
