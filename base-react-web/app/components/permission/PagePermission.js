...
export default class PagePermission extends React.Component {
    constructor(props) {
        super(props)
    ...
    create = () => {
        // this.$router.push({ path: "/permissions/new/" });
    }

    editPermission = (_permission) => {
        // this.$router.push({ path: "/permissions/edit/" + _permission.id });
        console.log("editando permission ", _permission);
    }
    ...
    removePermission = (_permission) => {
        console.log("removendo permission ", _permission);
    }
                            ...
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/permissions/new">Novo Registro </NavLink>
                                                ...
                                                return (
                                                    <tr key={permission.id}>
                                                        ...
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editPermission(permission)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removePermission(permission)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Permissão">
