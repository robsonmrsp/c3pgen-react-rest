/* MaturityRating´s Search Page generated by JSetup v0.95 :  at 01/12/2019 12:41:14  */
...
export default class PageMaturityRating extends React.Component {
    constructor(props) {
        super(props)
    ...
    create = () => {
        // this.$router.push({ path: "/maturityRatings/new/" });
    }

    editMaturityRating = (_maturityRating) => {
        // this.$router.push({ path: "/maturityRatings/edit/" + _maturityRating.id });
        console.log("editando maturityRating ", _maturityRating);
    }
    ...
    removeMaturityRating = (_maturityRating) => {
        console.log("removendo maturityRating ", _maturityRating);
    }
    ...
    paginate = (pageIndex = 1) => {
        ...
        this.service.getPage(
            ...
            error => {
                console.error("error fetching maturityRating´s page", error);
            }
        );
    }
                ...
                <div className="panel">
                    <div className="panel-heading">
                        <h3 className="panel-title">
                            ...
                            &nbsp;Pesquisa de Maturity rating.
                        </h3>
                    </div>
                    <div className="panel-body">
                        <div id="messages_div" />
                        <form id="formMaturityRatingFilter">
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/maturityRatings/new">Novo Registro </NavLink>
                                    ...
                                    <div className="col-sm-6">
                						<div className="input-group">
                                            <input type="text" value={this.state.datatableConfig.filterParameters.minimalAge} className="form-control" placeholder="Pesquisar Filme por por Minimal age" />
                            ...
                            <div className="panel" style={{ display: this.state.showFilter ? "block" : "none" }} >
                                ...
                                <div className="panel-body">
	                                <FormGroup controlId="controlIdMinimalAge"  > 
	                                    <ControlLabel>Minimal age</ControlLabel>
	                                    <JSInputField name="minimalAge" plugin="integer" type="text" value={this.state.datatableConfig.filterParameters.minimalAge}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
                        ...
                        <div className="cente">
                            <div className="table-responsive ">
                                ...
                                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                                    ...
                                    <tbody>
                                        {
                                            this.state.datatableConfig.items.map((maturityRating, index) => {
                                                return (
                                                    <tr key={maturityRating.id}>
                                                        <td>{maturityRating.minimalAge}</td>
                                                        <td>{maturityRating.name}</td>
                                                        <td>{maturityRating.description}</td>
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editMaturityRating(maturityRating)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeMaturityRating(maturityRating)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Maturity rating">
