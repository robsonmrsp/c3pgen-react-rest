...
export default class ModalMaturityRating extends React.Component {
    static defaultProps = {
        value: {
            minimalAge: "",
            name: "",
    ...
    onSelect = (maturityRating) => {
        console.log(maturityRating)
        this.props.onChange(maturityRating);
        this.closeModal();
    }
            ...
            <div >
                ...
                <Modal show={this.state.showModal} onHide={this.closeModal} bsSize="large" >
                    <Modal.Header closeButton>
                        <Modal.Title>Pesquisa de MaturityRating</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="">
