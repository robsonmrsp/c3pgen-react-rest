/* Item´s Search Page generated by JSetup v0.95 :  at 01/12/2019 12:41:14  */
...
export default class PageItem extends React.Component {
    ...
    create = () => {
        // this.$router.push({ path: "/items/new/" });
    }

    editItem = (_item) => {
        // this.$router.push({ path: "/items/edit/" + _item.id });
        console.log("editando item ", _item);
    }
    ...
    removeItem = (_item) => {
        console.log("removendo item ", _item);
    }
                            ...
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/items/new">Novo Registro </NavLink>
                                                ...
                                                return (
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editItem(item)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeItem(item)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Item">
