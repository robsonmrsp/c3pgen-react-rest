/* Suggestion´s Search Page generated by JSetup v0.95 :  at 01/12/2019 12:41:14  */
...
export default class PageSuggestion extends React.Component {
    constructor(props) {
        super(props)
    ...
    create = () => {
        // this.$router.push({ path: "/suggestions/new/" });
    }

    editSuggestion = (_suggestion) => {
        // this.$router.push({ path: "/suggestions/edit/" + _suggestion.id });
        console.log("editando suggestion ", _suggestion);
    }
    ...
    removeSuggestion = (_suggestion) => {
        console.log("removendo suggestion ", _suggestion);
    }
    ...
    paginate = (pageIndex = 1) => {
        ...
        this.service.getPage(
            ...
            error => {
                console.error("error fetching suggestion´s page", error);
            }
        );
    }
                ...
                <div className="panel">
                    <div className="panel-heading">
                        <h3 className="panel-title">
                            ...
                            &nbsp;Pesquisa de Suggestion.
                        </h3>
                    </div>
                    <div className="panel-body">
                        <div id="messages_div" />
                        <form id="formSuggestionFilter">
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/suggestions/new">Novo Registro </NavLink>
                                    ...
                                    <div className="col-sm-6">
                						<div className="input-group">
                                            <input type="text" value={this.state.datatableConfig.filterParameters.expirationDate} className="form-control" placeholder="Pesquisar Filme por por Expiration date" />
                            ...
                            <div className="panel" style={{ display: this.state.showFilter ? "block" : "none" }} >
                                ...
                                <div className="panel-body">
	                                <FormGroup controlId="controlIdExpirationDate"  > 
	                                    <ControlLabel>Expiration date</ControlLabel>
	                                    <JSInputField name="expirationDate" plugin="date" type="text" value={this.state.datatableConfig.filterParameters.expirationDate}  onChange={this.changeFormHandle} className="form-control" />
	                                </FormGroup>
                                    <div>
                        ...
                        <div className="cente">
                            <div className="table-responsive ">
                                ...
                                <table className="table table-striped table-bordered table-hover dataTable no-footer">
                                    <thead>
                                        <tr>
                                            <th className="th-expirationDate">
                                                <a >
                                                    <i className="fa " />
                                                    expiration date
                                                </a>
                                    ...
                                    <tbody>
                                        {
                                            this.state.datatableConfig.items.map((suggestion, index) => {
                                                return (
                                                    <tr key={suggestion.id}>
                                                        <td>{suggestion.expirationDate}</td>
                                                        <td className="td-actions action-butons-cell">
                                                            <button className="btn btn-xs  btn-primary " onClick={(event) => this.editSuggestion(suggestion)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar Filme">
                                                                <i className="fa fa-pencil fa-lg" />
                                                            </button>

                                                            <button className="btn btn-xs btn-danger " onClick={(event) => this.removeSuggestion(suggestion)} data-toggle="tooltip" data-placement="top" title="" data-original-title="Remover Suggestion">
